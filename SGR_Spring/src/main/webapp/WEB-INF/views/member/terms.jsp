...
<body>
	<form action="./join.jsp" name="form" method="get">
		<table width="1400" height="650">
			...
			<tr>
				<td height="60%" align="center">
					...
					<br>
					<p align="left">
						<span style="padding-left: 160px"> <b>SGR 약관동의</b></span>
...
- 생성정보 수집 툴을 통한 수집
			...
			<tr>
				<td align="center" valign="top"><img src="image/btn1.png"
					onclick="chk()">&nbsp;&nbsp;&nbsp; <img src="image/btn2.png"
					onclick="nochk()"></td>
			</tr>
		</table>
	</form>
