...
public class AdminController {
	...
	// 기본게시판 글 리스트
	@RequestMapping(value = "/listAll.ad", method = RequestMethod.GET)
	...
	// 게시판 글 리스트 페이징
	@RequestMapping(value = "/listCri.ad", method = RequestMethod.GET)
	...
	// @RequestMapping(value="/listPage.ad", method=RequestMethod.GET)
	...
	// 게시판 글보기
	@RequestMapping("/listDetail.ad")
	public void listDetail(@RequestParam("mb_no") int mb_no, @ModelAttribute("cri") SearchCriteria cri, Model model)
			throws Exception {
		System.out.println("회원 상세보기");
		model.addAttribute("member", adminService.listDetail(mb_no));
	}

	// 회원 강제 탈퇴 처리
	@RequestMapping(value = "/memberDrop.ad")
	public String memberDropProcess(@RequestParam("mb_no") int mb_no, SearchCriteria cri, RedirectAttributes rttr)
			throws Exception {
		System.out.println("회원 강제 탈퇴 mb_no : " + mb_no);
		System.out.println("회원등급:");
		adminService.memberDrop(mb_no);
		rttr.addAttribute("page", cri.getPage());
		rttr.addAttribute("perPageNum", cri.getPerPageNum());
		rttr.addAttribute("searchType", cri.getSearchType());
		rttr.addAttribute("keyword", cri.getKeyword());
		rttr.addFlashAttribute("msg", "SUCCESS");
		rttr.addFlashAttribute("delete", "회원번호 " + mb_no + "번 님을 강제 탈퇴 시키셨습니다.");
